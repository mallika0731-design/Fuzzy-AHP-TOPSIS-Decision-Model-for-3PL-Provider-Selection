...
The project generates several visualizations to interpret the decision model and ranking results.

| File | Description |
|-----|-------------|
| DS1 | Criteria weight distribution derived from Fuzzy AHP |
| DS2 | Normalized decision matrix visualization |
| DS3 | Weighted criteria contribution comparison |
| DS4 | TOPSIS score distribution across providers |
| DS5 | TOPSIS ranking of the 3PL providers |
| DS6 | Comparison between TOPSIS and Fuzzy Inference System scores |
| DS7 | Correlation analysis between decision models |

These visualizations help analyze how different criteria influence the ranking and how consistent the decision methods are.

---

## Outputs

The following output files contain the final results generated by the model.

| File | Description |
|-----|-------------|
| DSO1 | Final TOPSIS ranking results for all providers |
| DSO2 | Fuzzy Inference System scores and ranking |
| DSO3 | Monte Carlo simulation results showing ranking robustness |

These outputs summarize the decision model results and allow further analysis of the logistics provider evaluation.
...
### TOPSIS Ranking of 3PL Providers
![DS5](DS5.png)

### TOPSIS vs FIS Comparison
![DS6](DS6.png)
